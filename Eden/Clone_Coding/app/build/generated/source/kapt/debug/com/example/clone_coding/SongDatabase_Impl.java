...
public final class SongDatabase_Impl extends SongDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `SongTable` (`title` TEXT NOT NULL, `singer` TEXT NOT NULL, `currentTime` INTEGER NOT NULL, `playTime` INTEGER NOT NULL, `isPlaying` INTEGER NOT NULL, `music` TEXT NOT NULL, `coverImg` INTEGER, `isLike` INTEGER NOT NULL, `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)");
        ...
        _db.execSQL("CREATE TABLE IF NOT EXISTS `AlbumTable` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `title` TEXT, `singer` TEXT, `coverimg` INTEGER, `isSwitchOn` INTEGER NOT NULL)");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '720012cfc35bfa66d9ab794101fba1c8')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsSongTable.put("currentTime", new TableInfo.Column("currentTime", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoSongTable.equals(_existingSongTable)) {
          return new RoomOpenHelper.ValidationResult(false, "SongTable(com.example.clone_coding.Song).\n"
                  + " Expected:\n" + _infoSongTable + "\n"
                  + " Found:\n" + _existingSongTable);
        }
        ...
        if (! _infoUserTable.equals(_existingUserTable)) {
          return new RoomOpenHelper.ValidationResult(false, "UserTable(com.example.clone_coding.User).\n"
                  + " Expected:\n" + _infoUserTable + "\n"
                  + " Found:\n" + _existingUserTable);
        }
        final HashMap<String, TableInfo.Column> _columnsAlbumTable = new HashMap<String, TableInfo.Column>(5);
        ...
        _columnsAlbumTable.put("isSwitchOn", new TableInfo.Column("isSwitchOn", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoAlbumTable.equals(_existingAlbumTable)) {
          return new RoomOpenHelper.ValidationResult(false, "AlbumTable(com.example.clone_coding.Album).\n"
                  + " Expected:\n" + _infoAlbumTable + "\n"
                  + " Found:\n" + _existingAlbumTable);
        }
        ...
        if (! _infoLikeTable.equals(_existingLikeTable)) {
          return new RoomOpenHelper.ValidationResult(false, "LikeTable(com.example.clone_coding.Like).\n"
                  + " Expected:\n" + _infoLikeTable + "\n"
                  + " Found:\n" + _existingLikeTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "720012cfc35bfa66d9ab794101fba1c8", "f3f3ba1a348cbef661cbb2e63dc1028a");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "SongTable","UserTable","AlbumTable","LikeTable");
  }
