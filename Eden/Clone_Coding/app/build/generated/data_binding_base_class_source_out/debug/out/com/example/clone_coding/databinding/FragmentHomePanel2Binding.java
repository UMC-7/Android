...
public final class FragmentHomePanel2Binding implements ViewBinding {
  ...
  public static FragmentHomePanel2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home_panel2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentHomePanel2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomePanel2Binding((ConstraintLayout) rootView, homePannelAlbumImgIv,
