...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main,
      ...
      @NonNull ConstraintLayout mainPlayerCl, @NonNull SeekBar mainProgressSb) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.main_progress_sb;
      SeekBar mainProgressSb = ViewBindings.findChildViewById(rootView, id);
      if (mainProgressSb == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, main, mainBnv, mainFrm,
          mainMiniplayerBtn, mainMiniplayerSingerTv, mainMiniplayerTitleTv, mainPauseBtn,
          mainPlayerCl, mainProgressSb);
    }
