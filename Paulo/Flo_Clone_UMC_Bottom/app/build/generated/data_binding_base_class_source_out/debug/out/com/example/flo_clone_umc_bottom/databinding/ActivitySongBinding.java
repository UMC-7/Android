...
public final class ActivitySongBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView songRandomingIv;
  ...
  @NonNull
  public final ImageView songRepeatingIv;
  ...
  private ActivitySongBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView songAlbumIv,
      ...
      @NonNull ImageView songRandomingIv, @NonNull ImageView songRelatedIv,
      @NonNull ImageView songRepeatIv, @NonNull ImageView songRepeatingIv,
    ...
    this.songRandomingIv = songRandomingIv;
    this.songRelatedIv = songRelatedIv;
    this.songRepeatIv = songRepeatIv;
    this.songRepeatingIv = songRepeatingIv;
  ...
  public static ActivitySongBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.song_randoming_iv;
      ImageView songRandomingIv = ViewBindings.findChildViewById(rootView, id);
      if (songRandomingIv == null) {
        break missingId;
      }
      ...
      id = R.id.song_repeating_iv;
      ImageView songRepeatingIv = ViewBindings.findChildViewById(rootView, id);
      if (songRepeatingIv == null) {
        break missingId;
      }
      ...
      return new ActivitySongBinding((ConstraintLayout) rootView, songAlbumIv, songDownIb,
          ...
          songRandomingIv, songRelatedIv, songRepeatIv, songRepeatingIv, songSettingIb,
