  ...
  public UserDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `UserTable` (`email`,`password`,`name`,`id`) VALUES (?,?,?,nullif(?, 0))";
      }
  ...
  public List<User> getUsers() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item = new User(_tmpEmail,_tmpPassword,_tmpName);
        final int _tmpId;
  ...
  public User getUser(final String email, final String password) {
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        _result = new User(_tmpEmail,_tmpPassword,_tmpName);
        final int _tmpId;
        _tmpId = _cursor.getInt(_cursorIndexOfId);
