...
public class FragmentBottomSheetBindingImpl extends FragmentBottomSheetBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.button_row, 1);
        sViewsWithIds.put(R.id.bottom_sheet_play_btn, 2);
        sViewsWithIds.put(R.id.bottom_sheet_playlist_btn, 3);
        sViewsWithIds.put(R.id.bottom_sheet_mylist_btn, 4);
        sViewsWithIds.put(R.id.bottom_sheet_delete_btn, 5);
    }
    // views
    @NonNull
