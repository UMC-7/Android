...
public final class SongDatabase_Impl extends SongDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `SongTable` (`title` TEXT NOT NULL, `singer` TEXT NOT NULL, `second` INTEGER NOT NULL, `playTime` INTEGER NOT NULL, `isPlaying` INTEGER NOT NULL, `music` TEXT NOT NULL, `coverImg` INTEGER, `isLike` INTEGER NOT NULL, `albumIdx` INTEGER NOT NULL, `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)");
        ...
        _db.execSQL("CREATE TABLE IF NOT EXISTS `UserTable` (`email` TEXT NOT NULL, `password` TEXT NOT NULL, `name` TEXT NOT NULL, `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '69fbcdc3da42829c83f6ce003ab46d42')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsSongTable = new HashMap<String, TableInfo.Column>(10);
        ...
        _columnsSongTable.put("albumIdx", new TableInfo.Column("albumIdx", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoSongTable.equals(_existingSongTable)) {
          return new RoomOpenHelper.ValidationResult(false, "SongTable(com.example.androidfloclone.Song).\n"
                  + " Expected:\n" + _infoSongTable + "\n"
                  + " Found:\n" + _existingSongTable);
        }
        ...
        if (! _infoAlbumTable.equals(_existingAlbumTable)) {
          return new RoomOpenHelper.ValidationResult(false, "AlbumTable(com.example.androidfloclone.Album).\n"
                  + " Expected:\n" + _infoAlbumTable + "\n"
                  + " Found:\n" + _existingAlbumTable);
        }
        ...
        if (! _infoUserTable.equals(_existingUserTable)) {
          return new RoomOpenHelper.ValidationResult(false, "UserTable(com.example.androidfloclone.User).\n"
                  + " Expected:\n" + _infoUserTable + "\n"
                  + " Found:\n" + _existingUserTable);
        }
        ...
        if (! _infoLikeTable.equals(_existingLikeTable)) {
          return new RoomOpenHelper.ValidationResult(false, "LikeTable(com.example.androidfloclone.Like).\n"
                  + " Expected:\n" + _infoLikeTable + "\n"
                  + " Found:\n" + _existingLikeTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "69fbcdc3da42829c83f6ce003ab46d42", "a8b0c7d7010b87d17dca26d0e5f07ebb");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "SongTable","AlbumTable","UserTable","LikeTable");
  }
