...
public final class FragmentLockerBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView lockerPlayAllIv;
  ...
  private FragmentLockerBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView lockerLoginTv, @NonNull ImageView lockerPlayAllIv,
      @NonNull TextView lockerPlayAllTv, @NonNull ImageView lockerSelectAllIv,
    ...
    this.lockerPlayAllIv = lockerPlayAllIv;
  ...
  public static FragmentLockerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.locker_play_all_iv;
      ImageView lockerPlayAllIv = ViewBindings.findChildViewById(rootView, id);
      if (lockerPlayAllIv == null) {
        break missingId;
      }
      ...
      return new FragmentLockerBinding((ConstraintLayout) rootView, lockerContentTb,
          lockerContentVp, lockerLoginTv, lockerPlayAllIv, lockerPlayAllTv, lockerSelectAllIv,
